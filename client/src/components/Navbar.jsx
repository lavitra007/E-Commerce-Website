    ...
    return (
        <>
            ...
            <nav style={{ 
                ...
                <Link to="/collection?category=exclusive-release" style={{ position: 'relative', transition: 'opacity 0.3s ease', opacity: 0.8, paddingBottom: '2px' }} onMouseOver={e => { e.currentTarget.style.opacity = 1; e.currentTarget.style.textDecoration = 'underline'; e.currentTarget.style.textUnderlineOffset = '4px'; }} onMouseOut={e => { e.currentTarget.style.opacity = 0.8; e.currentTarget.style.textDecoration = 'none'; }}>Exclusive Release</Link>
            </nav>
        </>
    );
};
